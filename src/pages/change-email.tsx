...
const ChangeEmail = () => {
	...
	return (
		<UserLayout>
			<div className=' mx-auto my-20 md:w-6/12 space-y-4'>
				...
				<DialogBody divider>
					<ul className='text-left list-disc text-xs'>
						<li className="before:content-['•'] before:block before:mr-2 flex">
							You will need to log in to your account after changing your email.
						</li>
						...
						<div className='space-y-4 text-gray-700 '>
							...
							<div className='my-6 space-y-4'>
								<button
									...
									disabled={
										newCodeLoading || isChangeEmailLoading || code.length < 6
									}
								>
