...
const Register = () => {
	...
	// set referral id from query
	// useEffect(() => {
	// 	if (referral_id) {
	// 		setReferral(referral_id);
	// 	}
	...
	const handleSubmit = (e: { preventDefault: () => void }) => {
		...
		const data = {
			...
			referral: referralCode ? referralCode : '169660669758',
		};
	...
	return (
		<div className='register-wrapper'>
			...
			<div className='px-6 mx-auto my-10 md:w-6/12 '>
				<h1 className='text-2xl font-bold text-center text-white gradient-text '>
					Create your account
				</h1>
				<div className='my-8'>
