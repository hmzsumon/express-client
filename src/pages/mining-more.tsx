		...
		<UserLayout>
			<div className='px-2 py-4 space-y-4'>
				...
				<p className='text-xs font-semibold leading-5 tracking-widest text-cyan-100'>
					...
					system and the number of users mining ELC.
				</p>
				<p className='text-xs font-semibold leading-5 tracking-widest text-cyan-100'>
					...
					developed a system that dynamically adjusts the mining
					rate in real-time.
				</p>
				<p className='text-xs font-semibold leading-5 tracking-widest text-cyan-100'>
					...
					between maximizing returns for miners and maintaining the long-term
