...
const TABLE_HEAD = ['ID', 'Registration Date', 'Verification', 'Mining', ''];
	...
	return (
		<Card className='w-full h-full bg-blue-gray-900'>
			<CardHeader floated={false} shadow={false} className='rounded-none'>
				<div className='flex flex-col items-center justify-between gap-4 bg-blue-gray-900 md:flex-row'>
					{' '}
												...
												<td className={classes}>
													<div className='flex items-center gap-3 text-white'>
														...
														<div className='flex flex-col'>
															...
															>
																{customer_id}{' '}
																<sup className='text-yellow-700 '>{level}</sup>
															</Typography>
															<Typography
																variant='small'
																color='blue-gray'
