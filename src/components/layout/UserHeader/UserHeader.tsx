...
import Notification from './Notifecation';
...
const UserHeader = () => {
	...
	return (
		<>
			<div className=' bg--gradient  py-4 px-4 border-b border-[#282b35] '>
				<div className='flex items-center justify-between '>
					...
					<div className='flex items-center justify-center gap-6 '>
						...
						<button
							className='flex items-center justify-center rounded-full bg-btn w-7 h-7 '
							onClick={handleOpen}
						>
							<FaUser className=' text-cyan-100' />
						</button>
						{/* <button className=''>
