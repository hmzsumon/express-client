	...
	return (
		<li className='relative z-50 list-none'>
			...
			<div
				...
				className={`absolute -right-27 mt-2.5 flex h-90 w-80 flex-col rounded-sm border border-stroke bg-red-500 shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 ${
